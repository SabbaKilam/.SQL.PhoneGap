...
function buildResultSetTable(csvRecordSet){
    try{
        ...
        O(spanTag).appendChild(centerTag);
        O(centerTag).appendChild(node);
...
//=====================================
O(btnSaveFile).onclick = function(){
...
var saveOptions = {
    ...
    success: function(){
        alert("Succes: File saved to dropbox.");
    },
    error: function(){
